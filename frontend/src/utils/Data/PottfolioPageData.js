...
export const portfolioData = [
  ...
  {
    name: "mission-related investing",
    totalValue: 100000,
    performance: 12,
    numHoldings: 23,
    lastUpdated: "today",
...
const mergedData = data.map((symbol) => "NSE:" + symbol);

const dummydatafolio = mergedData.slice(0, 10).map((symbol) => {
  return { name: symbol };
});
